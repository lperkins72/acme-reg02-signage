...
This folder is the region-default content layer for `reg02`.
...
- `regions/reg02/data/primary-assets.json`
- `regions/reg02/data/primary.json`
- `regions/reg02/data/footer.json`
- `regions/reg02/data/primaryending.json`
- `regions/reg02/assets/primary/manifest.json`
- `regions/reg02/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg02`.
